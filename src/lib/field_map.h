...
#define gObjectEvents ((struct ObjectEvent*)0x030048A0)
#define gSelectedObjectEvent (*(u8*)0x03004AE0)
#define gMapHeader (*(struct MapHeader*)0x0202E828)
#define gPlayerAvatar (*(struct PlayerAvatar*)0x0202E858)
